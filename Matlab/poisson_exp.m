...
num_nodes = 15;
num_data_sym = 28;
path = ['C:\Osama\Matlab_lt\1min_SF8_tx'];

tic
for k = [1:15];%[0.5:0.5:3.5]
    k
for iter = [1]
    iter
...
fi_1 = fopen([path '\' num2str(k) 'tx_lm' num2str(iter) '_1']);
...
%%
for m = [4:size(pkts,1)]%[2:69 71:81 83:size(pkts,1)]%
    %%
